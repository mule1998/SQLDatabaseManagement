...
CREATE TABLE hired_citizen(
	...
	PRIMARY KEY (hired_city)
)
PARTITION BY LIST COLUMNS(hired_city) (
    PARTITION pRegion_1 VALUES IN('Gudgoan', 'lonavala'),
    PARTITION pRegion_2 VALUES IN('Mumbai',  'Jaipur'),
    PARTITION pRegion_3 VALUES IN('Pune', 'Nashik' )
);
...
VALUES 
	...
	(102,"Dibyesh",Null, "Mishra", "dm@gmail.com", 8007994455, "lonavala", "2016-01-08 12:20:56","MCA", 648255, 
	...
	"Happiest Minds", "Great Vision", "Excellent", "Excellent", "Excellent", "active","2022-04-07 14:20:56",5),
	(106,"Sam",null, "Mishra", "sm@gmail.com", 8878894455, "Nashik", "2016-04-07 14:20:56","Btech", 245255, 
